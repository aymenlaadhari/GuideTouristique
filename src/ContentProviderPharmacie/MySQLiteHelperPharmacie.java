...
public class MySQLiteHelperPharmacie extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "pharmacie.db";
    ...
    public MySQLiteHelperPharmacie(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      Log.w(MySQLiteHelperPharmacie.class.getName(),
